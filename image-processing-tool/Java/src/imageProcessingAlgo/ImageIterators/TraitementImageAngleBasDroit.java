...
public class TraitementImageAngleBasDroit extends TraitementImage {

	private double [] noyau = {0.11111,0.22222,0.22222,0.44444};
	private int nbMedianRouge;
	private int nbMedianVert;
	private int nbMedianBleu;
